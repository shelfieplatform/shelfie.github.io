...
import { ArrowLeft, MessageCircle, Mail, Clock, Phone, Send, HelpCircle, Bug, Lightbulb, Users } from "lucide-react";
...
export default function ContactSupport(props: any) {
  ...
  const contactOptions = [
    ...
    {
      title: t('helpCenter.contact.liveChat.title'),
      description: t('helpCenter.contact.liveChat.description'),
      icon: MessageCircle,
      action: () => console.log("Live chat coming soon"),
      buttonText: t('helpCenter.contact.liveChat.button'),
      disabled: true
    },
    {
      title: t('helpCenter.contact.phoneSupport.title'),
      description: t('helpCenter.contact.phoneSupport.description'),
      icon: Phone,
      action: () => console.log("Phone support coming soon"),
      buttonText: t('helpCenter.contact.phoneSupport.button'),
      disabled: true
    }
  ];
  ...
  const supportInfo = [
    {
      title: t('helpCenter.contact.supportHours.title'),
      content: t('helpCenter.contact.supportHours.content'),
      icon: Clock
    },
    {
      title: t('helpCenter.contact.responseTimes.title'),
      content: t('helpCenter.contact.responseTimes.content'),
      icon: MessageCircle
    },
    {
      title: t('helpCenter.contact.escalationProcess.title'),
      content: t('helpCenter.contact.escalationProcess.content'),
      icon: HelpCircle
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#A690F2] to-[#2C1761] text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-8 text-center">
            {t('helpCenter.contact.supportInfo.title')}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
